...
<head>
    ...
    <style>
        ...
        * {
        ...
        .solmate-site-shell .shell {
            position: relative;
            isolation: isolate;
            padding-top: 26px;
        }

        .solmate-site-shell .shell::before {
            display: none;
        }
        ...
        .solmate-nav {
            ...
            border-radius: 20px;
            margin-bottom: 24px;
            box-shadow: 0 8px 24px rgba(18, 58, 90, 0.07), 0 0 0 1px rgba(32, 167, 201, 0.10);
        ...
        .solmate-hamburger {
            background: #f8fafc;
            border: 1px solid rgba(203, 219, 229, 0.9);
            padding: 7px 8px;
            cursor: pointer;
            color: #1E293B;
            display: flex;
        ...
        .solmate-hamburger:hover {
            background: #eef6ff;
            border-color: rgba(18, 58, 90, 0.24);
            color: #123A5A;
        }
        ...
        .solmate-profile-btn {
            ...
            height: 46px;
            border-radius: 50%;
            background: linear-gradient(135deg, #123A5A, #1C5476);
            border: 3px solid rgba(230, 194, 0, 0.72);
            cursor: pointer;
            display: flex;
            align-items: center;
            justify-content: center;
            ...
            line-height: 0;
            overflow: hidden;
            box-shadow: 0 6px 16px rgba(18, 58, 90, 0.14), 0 0 0 4px rgba(244, 208, 0, 0.08);
        }

        .solmate-profile-btn:hover {
            background: linear-gradient(135deg, #0F2F4A, #205E83);
            border-color: #F4D000;
        ...
        .solmate-profile-btn.has-image {
            background: #ffffff;
            border: 4px solid var(--solmate-cyan-400);
        }
        ...
        .solmate-services-trigger:hover {
            color: #123A5A;
            background: rgba(234, 249, 253, 0.6);
            transform: translateY(-1px);
        }
        ...
        .solmate-services-trigger:hover .solmate-services-chevron,
        .solmate-services-trigger.active .solmate-services-chevron {
            color: #123A5A;
            opacity: 1;
        }
        ...
        <div class="solmate-footer-bottom">
            ...
            <div class="solmate-footer-contact-items">
                <div class="solmate-footer-contact-item">
                    ...
                    <span>3852 Gumamela, Pasig, 1611 Metro Manila</span>
                </div>
                <div class="solmate-footer-contact-item">
