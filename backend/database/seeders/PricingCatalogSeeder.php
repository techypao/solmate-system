...
class PricingCatalogSeeder extends Seeder
{
    ...
    private function catalogItems(): array
    {
        return [
            ...
            [
                'name' => 'SRNE 51.2V 100Ah',
                'category' => 'battery',
                'unit' => 'pc',
                'default_unit_price' => 31500,
                'brand' => 'SRNE',
                'model' => '51.2V 100Ah',
            ],
            [
                'name' => 'MENRED 51.2V 120Ah',
                'category' => 'battery',
                'unit' => 'pc',
                'default_unit_price' => 46000,
                'brand' => 'MENRED',
                'model' => '51.2V 120Ah',
            ],
            [
                'name' => 'SRNE 51.2V 200Ah',
                'category' => 'battery',
                'unit' => 'pc',
                'default_unit_price' => 75000,
                'brand' => 'SRNE',
                'model' => '51.2V 200Ah',
            ],
            [
                'name' => 'SRNE 51.2V 205Ah',
                'category' => 'battery',
                'unit' => 'pc',
                'default_unit_price' => 59500,
                'brand' => 'SRNE',
                'model' => '51.2V 205Ah',
            ],
            [
                'name' => 'MENRED 51.2V 240Ah',
                'category' => 'battery',
                'unit' => 'pc',
                'default_unit_price' => 96000,
                'brand' => 'MENRED',
                'model' => '51.2V 240Ah',
            ],
            [
                'name' => 'SRNE 51.2V 314Ah',
                'category' => 'battery',
                'unit' => 'pc',
                'default_unit_price' => 76000,
                'brand' => 'SRNE',
                'model' => '51.2V 314Ah',
            ],
            [
