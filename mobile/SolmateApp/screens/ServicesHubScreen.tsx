...
export default function ServicesHubScreen({navigation}: any) {
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView
        ...
        <ShortcutCard
          label="My Installation Requests"
          subtitle="Review your submitted installation requests."
          onPress={() =>
        ...
        <ShortcutCard
          ...
          subtitle="Review your submitted maintenance requests."
          onPress={() =>
            navigation.navigate('ServiceRequestList', {
...
const styles = StyleSheet.create({
  ...
  title: {fontSize: 28, fontWeight: '900', color: NAVY, marginBottom: 4},
