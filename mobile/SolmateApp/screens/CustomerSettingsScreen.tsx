    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView
        ...
        <View style={styles.heroCard}>
          <Text style={styles.eyebrow}>Customer settings</Text>
          <Text style={styles.heroTitle}>{user?.name || 'Customer'}</Text>
          <Text style={styles.heroSubtitle}>
            Review your account information and manage your active session in
            one place.
          </Text>
        </View>
        ...
        <AppCard style={styles.sectionCard}>
          ...
          <Text style={styles.sectionSubtitle}>
            Details below come from your current signed-in customer account.
          </Text>
        ...
        <AppCard style={styles.sectionCard}>
          ...
          <Text style={styles.sectionSubtitle}>
            Edit your customer name and email here. Changes are saved directly
            to your account.
          </Text>
        ...
        <AppCard style={styles.sectionCard}>
          ...
          <Text style={styles.sectionSubtitle}>
            Sign out when you are done using the customer mobile app.
          </Text>
